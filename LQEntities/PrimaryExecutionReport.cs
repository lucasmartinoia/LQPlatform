...
namespace INOM.Entities
{
   ...
   */
    ...
    public class BymaExecutionReport
    {
        public BymaExecutionReport()
        {
            MsgType = "8";
            OrderCapacity = "A";
            NoPartyIDs = 1;
        ...
        /// <summary>
        /// Object BymaOrder order.
        /// </summary>
        [Required]
        public BymaOrder BymaOrder { get; set; }
        ...
        public static void Save(BymaExecutionReport bymaExecutionReport)
        {
            using (var db = new DBContext())
            {
                db.BymaExecutionReports.Add(bymaExecutionReport);
                db.SaveChanges();
            }
        }
    }

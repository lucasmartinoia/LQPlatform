...
namespace INOM.Entities
{
    public class MarketHist
    {
        ...
        /// <returns></returns>
        public static List<MarketHist> GetList()
        {
            using (var db = new DBContext())
            {
                return (from data in db.MarketsHist select data).ToList();
            }
        }
        ...
        /// <returns></returns>
        public static MarketHist Get(int idMarket)
        {
            using (var db = new DBContext())
            {
                return (from data in db.MarketsHist
        ...
        /// <returns></returns>
        public static MarketHist Save(MarketHist market)
        {
            using (var db = new DBContext())
            {
                db.MarketsHist.Add(market);
                db.SaveChanges();
        ...
        public static MarketHist Update(MarketHist marketMapper)
        {
            using (var db = new DBContext())
            {
                db.MarketsHist.Attach(marketMapper);
        ...
        public static MarketHist Verify(MarketHist marketMapper)
        {
            using (var db = new DBContext())
            {
                db.MarketsHist.Attach(marketMapper);

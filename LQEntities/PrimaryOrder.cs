...
namespace INOM.Entities
{
    ...
    public class BymaOrder
    {
        ...
        /// <summary>
        /// Byma´s Trades generated to satisfy this Byma Order.
        /// </summary>
        public virtual List<BymaExecutionReport> BymaExecutionsReport { get; set; }
        ...
        public static void Save(BymaOrder bymaOrder)
        {
            using (var db = new DBContext())
            {
                db.BymaOrders.Add(bymaOrder);
                db.SaveChanges();
            }
        }

        public static void Update(BymaOrder bymaOrder)
        {
            using (var db = new DBContext())
            {
                db.BymaOrders.Update(bymaOrder);
                db.Entry(bymaOrder).State = EntityState.Modified;
                db.SaveChanges();
            }
        }
    }

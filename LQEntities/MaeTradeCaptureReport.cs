...
{
    public partial class MaeTradeCaptureReport
    {
        public MaeTradeCaptureReport()
        {
            MsgType = "AE";
        }
        [Key]
        ...
        public static void Save(MaeTradeCaptureReport MaeTradeCaptureReport)
        {
            using (var db = new DBContext())
            {
                db.MaeTradeCaptureReports.Add(MaeTradeCaptureReport);
                db.SaveChanges();
            }
        }
    }
